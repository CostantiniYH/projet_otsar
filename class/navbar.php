...
class Navbar {
    ...
    public function render() {
        ...
        if ($this->dropdownItems) {
            echo '<div class="center rounded-4 bg-white dropdown collapse navbar-collapse" id="navbarNav">';
        ...
        echo '<div class="navbar-section center collapse navbar-collapse" id="navbarNav">';
            $this->renderItems($this->centerItems);        
        echo '</div>';

        echo '<div class="navbar-section right collapse navbar-collapse" id="navbarNav">';
