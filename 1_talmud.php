...
<div class="container">
    ...
    <div class="row mb-5">
        <div class="col me-5 img-map img-gmara" data-aos=" fade-up" data-aos-duration="1500" data-aos-delay="2500">
            <img src="./img/chass-vilna.png" class="card-img rounded-4 shadow" alt="תלמוד בבלי" usemap="#map_3">
            <map name="map_3">
        ...
        <div class="col ms-5 img-map img-gmara" data-aos=" fade-up" data-aos-duration="1500" data-aos-delay="2500">
            <img src="./img/yerouchalmi.png" class="card-img rounded-4 shadow" alt="תלמוד ירושלמי" usemap="#map_4">
            <map name="map_4">
