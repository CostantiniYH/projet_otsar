<div class="card border-0 shadow hvr-shadow-radial"  style="width: 18rem;">
  <img src="<?= BASE_URL . 'uploads/' . $value['nom_path'] . '/' . $value['image']; ?>" class="card-img-top card-img" 
  alt="<?= $value['titre']; ?>" style="height: 200px; object-fit: cover;" usemap="#map<?= $value['id']; ?>">
