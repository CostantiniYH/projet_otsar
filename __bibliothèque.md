...
Taille du Texte
----------------------------------
.fs-1 à .fs-6 : Tailles de texte spécifiques (.fs-1 étant le plus grand, .fs-6 le plus petit).
.small : Texte plus petit.

Poids de la Police
----------------------------------
.fw-light : Texte léger.
.fw-normal : Texte de poids normal (par défaut).
.fw-bold : Texte en gras.
.fw-bolder : Texte plus gras que .fw-bold.
.fw-italic : Texte en italique.
...
----------------------------------
.text-lowercase : Transforme le texte en minuscules.
.text-uppercase : Transforme le texte en majuscules.
.text-capitalize : Met en majuscule la première lettre de chaque mot.
...
----------------------------------
.text-wrap : Permet le retour à la ligne dans un texte long.
.text-nowrap : Empêche le retour à la ligne dans un texte long.
.text-break : Permet la cassure de mots longs pour éviter le débordement.
