...
if (isLoggedIn()) {
    ...
    $navbar->AddItem('גמרא','Talmud/1_talmud.php','dropdown', true);
    ...
    $navbar->AddItem('גמרא','Talmud/1_talmud.php','center', true);
...
<div class="container">
    ...
    <div class="row mb-5">
        <div class="col-md-6 mx-auto d-flex mt-5" data-aos=" fade-up" data-aos-duration="1500" data-aos-delay="2500">
