...
if (!isLoggedIn()) {
    ...
    getUserSession();
    $success = 'Félicitation ' . htmlspecialchars($_SESSION['user']['prenom']) . ', vous avez accès au מוסר!';
}
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col me-5 img-map img-mousar" data-aos=" fade-up" data-aos-duration="1500" data-aos-delay="2500">
                <img src="./img/mousar.png" class="card-img rounded-4 shadow" alt="מוסר" usemap="#map_3">
                <map name="map_3">
